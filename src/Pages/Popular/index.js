    ...
    _renderItem = ({ item, index }) => (
        <View style={{
            ...
            {/* <TouchableOpacity style={{ marginTop: 0, width: 40, height: 80 }} onPress={() => this.removeItem(item, index)}>
                <Image style={{ height: 25, width: 25, marginLeft: 0, marginTop: 15 }} source={closeIcon} resizeMode="contain" />
            </TouchableOpacity> */}
        </View>
            ...
            <Fragment>
                ...
                <View style={{ flex: 1, backgroundColor: '#fff' }}>
                    ...
                    <ImageBackground style={{ flex: 1, alignItems: 'center' }} source={Images.BACKGROUND_JPG} resizeMode="stretch">
                        <Header title="Cursos Populares" is_left={true} onLeftPress={() => this.props.navigation.goBack()} />
                        <FlatList
